                                    ...
                                    CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'email', 'mturk_id', 'password', 'role_id'];
    ...
    {
    # With timetsamps() will ensure the pivot table has its created_at/updated_at fields automatically maintained
    return $this->belongsToMany('oceler\Trial')->withPivot('group_id', 'last_ping', 'instructions_read', 'selected_for_removal')->withTimestamps();
    }
